...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-64 bg-slate-900 border-r border-slate-800 flex flex-col transition-transform duration-300 ease-in-out md:translate-x-0 ${
        ...
        <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
          <div className="px-3 mb-2">
            <p className="text-[11px] font-bold uppercase tracking-wider text-slate-500">
              {isAdmin ? 'Management' : 'Technician Hub'}
            </p>
          </div>
        ...
        <div className="p-4 border-t border-slate-800">
          <div className="bg-slate-950/60 border border-slate-800 rounded-xl p-3">
            <div className="flex items-center gap-2">
              ...
              <p className="text-xs font-semibold text-slate-300">Live Shop System</p>
            </div>
